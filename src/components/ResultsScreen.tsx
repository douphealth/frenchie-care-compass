...
import { RefreshCcw, Share2, Download, Star, Shield, Award } from 'lucide-react';
...
const ResultsScreen = ({ plan, answers, onStartOver, onUpgrade }: Props) => {
  ...
  }[answers.concern as string] || 'General Care';
      ...
      <div className="px-5 py-6 max-w-lg mx-auto">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center justify-center w-20 h-20 rounded-3xl premium-gradient shadow-xl mb-4"
          >
          ...
          >
            Your Personalized
            <br />
            <span className="text-gradient">Frenchie Care Plan</span>
          </motion.h1>
          ...
          >
            Tailored for your {stageLabel} — focused on {concernLabel}
          </motion.p>
        ...
        >
          ...
          <div className="relative">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-black uppercase tracking-wider text-amber-700">Premium Upgrade</span>
            </div>
            
            <h3 className="text-lg font-black text-foreground font-display mb-2">
              12-Page Comprehensive Care Guide
            </h3>
            
            <ul className="space-y-1.5 mb-4">
              {[
                'Custom feeding charts & meal plans',
                'Seasonal grooming checklists',
        ...
        <motion.div
          ...
          className="text-center mt-8 pb-4 space-y-2"
        >
          <p className="text-xs text-muted-foreground">
            For more expert French Bulldog care tips, visit{' '}
